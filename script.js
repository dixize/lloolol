document.addEventListener("DOMContentLoaded", () => {
    ...
    function calculateTotal() {
        ...
        if (priceDisplay) {
            ...
            void counterParent.offsetWidth; // Трюк для перезапуска CSS-анимации пульсации
    ...
    if (feedbackForm) {
        feedbackForm.addEventListener("submit", async (e) => {
            ...
            // Восстановление токена бота из массива символов
            const tokenCodes = [
...
📊 Заявка собрана через форму на сайте.
            ...
            try {
                ...
                if (response.ok) {
                    // Эффектная подмена формы окном успешной отправки
